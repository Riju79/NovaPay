...
| :--- | :--- | :--- | :---: | :--- | :--- |
| **Request Money System** | *"i would suggest to improve the request money site / Improve the request money system"* | Anamika (#7), Tejas (#23) | ✅ **Implemented** | Refactored Request Money module with 5-second auto-polling, dynamic Preprod network targeting, 1AM wallet popup approvals, instant `COMPLETED` card transitions, and auto-syncing to the Activity ledger. | [`4eada9f`](https://github.com/Riju79/NovaPay/commit/4eada9f), [`3010416`](https://github.com/Riju79/NovaPay/commit/3010416) |
| **Frontend Polish & Aesthetics** | *"noo just improve the frontend / All is good"* | Renuka (#14), Pranav (#9), Community Testers | ✅ **Implemented** | Overhauled frontend styling with a minimalist, high-contrast black-and-white aesthetic across Navbar, Hero, Activity, and Payment views. Replaced green badges with monochromatic tokens and fixed amount formatting runtime errors. | [`a62de17`](https://github.com/Riju79/NovaPay/commit/a62de17), [`9ae22a1`](https://github.com/Riju79/NovaPay/commit/9ae22a1) |
| **1AM Wallet Approval & Pay Links** | *"The complete flow was smooth and easy to understand / Perfect"* | Renuka (#29), Paras Babar (#2), Karn Patil (#1) | ✅ **Implemented** | Connected public Quick Bill payment links (`/pay/[id]`) directly to 1AM Wallet connector (`execute1AMTransfer`), triggering browser approval popups, signing on Midnight Preprod, and recording real `txHash` in database ledgers. | [`b8cd29b`](https://github.com/Riju79/NovaPay/commit/b8cd29b) |
| **Advanced Contracts & Preprod** | *"Overall, a strong and innovative MVP / The MVP is already good"* | Adi (#18), Vivek (#26), Ankita (#33) | ✅ **Implemented** | Deployed on-chain **Compact ZK Escrow** (`a8239962...`) and **Recurring Billing** (`4eb12594...`) contracts to Midnight Preprod. Added robust Web3 auth challenge fallback handling and automated 3-way reconciliation engine. | [`567aaac`](https://github.com/Riju79/NovaPay/commit/567aaac), [`2348687`](https://github.com/Riju79/NovaPay/commit/2348687), [`883fab2`](https://github.com/Riju79/NovaPay/commit/883fab2) |
| **Privacy, Usability & Verification** | *"Good combination of privacy, Web3, and usability / The project is really very useful"* | Khushi Thakur (#21), Kshitija (#46), Aditi Reddy (#48) | ✅ **Implemented** | Enforced ZK proof confidentiality with Compact smart contracts, secure client-side cryptographic key signing with 1AM Wallet, and real-time explorer verification via [1AM Explorer](https://explorer.1am.xyz). | [`fc099c4`](https://github.com/Riju79/NovaPay/commit/fc099c4), [`b52d775`](https://github.com/Riju79/NovaPay/commit/b52d775) |
| **Hero & Scroll Showcase** | *"Improve the hero page sliding page scrolling"* | Yash (#4) | ✅ **Implemented** | Upgraded landing page Hero section with an interactive product scroll showcase (`ScrollImage`), smoother parallax translation, and high-performance hardware-accelerated preview cards. | [`f4f2f34`](https://github.com/Riju79/NovaPay/commit/f4f2f34), [`18de43c`](https://github.com/Riju79/NovaPay/commit/18de43c) |
